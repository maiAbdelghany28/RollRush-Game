...
void displayMenu() {
    ...
    drawText(-0.25f, 0.4f, "Race Challenge");

    // Draw Main Menu options with highlight on selected option
    if (screenState == 0) {
        vector<string> menuOptions = {"Single Player", "Multiplayer"};
        ...
        drawText(-0.25f, 0.3f, "Multiplayer Modes");
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Race Challenge");
